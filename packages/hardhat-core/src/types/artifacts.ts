...
/**
 * This interface allows plugins to extend Hardhat's artifact loading logic.
 *
 * It provides a read-only version of Artifacts, without any caching-logic.
 * Caching is handled by the Artifacts implementation.
 */
export interface ArtifactsExtension {
  /**
