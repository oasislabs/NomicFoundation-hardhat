...
import {
  ...
  RpcBlockWithTransactions,
} from "./types/output/block";
import { decodeJsonRpcResponse } from "./types/output/decodeJsonRpcResponse";
import { rpcLog } from "./types/output/log";
import { rpcTransactionReceipt } from "./types/output/receipt";
import { rpcTransaction } from "./types/output/transaction";
