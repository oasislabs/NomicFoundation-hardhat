...
import { RpcBlockWithTransactions } from "../jsonrpc/types/output/block";
import { RpcTransactionReceipt } from "../jsonrpc/types/output/receipt";
import { RpcTransaction } from "../jsonrpc/types/output/transaction";
